...
!(function (n, t) {
  ...
  var s,
    ...
    Ci =
      ...
      (D[xi.p] = {
        ...
        wrapAll: function (n) {
          for (var t, r = this, e = D(n)[0], i = e, o = r[0].parentNode, u = r[0].previousSibling; 0 < i.childNodes[xi.l]; ) i = i.childNodes[0];
        ...
        eq: function (n) {
          return D(this[0 <= n ? n : this[xi.l] + n]);
        },
        find: function (t) {
          var r,
            e = [];
      ...
      b(D, { extend: b, inArray: H, isEmptyObject: L, isPlainObject: R, each: e }),
      D);
  function b() {
    var n,
      t,
      ...
      a = arguments[xi.l],
      c = !1;
    for (d(u) == wi && ((c = u), (u = arguments[1] || {}), (f = 2)), d(u) != pi && !d(u) == bi && (u = {}), a === f && ((u = D), --f); f < a; f++)
  ...
  function N(n, t) {
    var r, e;
    !1 !== t && n.q.splice(0, 1),
      0 < n.q[xi.l] ? ((e = n.q[0]), x(n.el, e.props, e.duration, e.easing, e.complete, !0)) : -1 < (r = H(n, T)) && T.splice(r, 1);
  }
  function W(n, t, r) {
  ...
  function x(n, t, r, e, i, o) {
    ...
    for (u in (f || ((f = { el: n, q: [] }), T.push(f)), t)) h[u] = u === k || u === I ? n[u] : D(n).css(u);
    ...
    q =
      ...
      (Ii = {
        g: (V = function (i) {
          var o = function (n) {
            var t, r, e;
            for (t in n) n[xi.hOP](t) && ((r = n[t]), (e = M(r)) == mi ? (n[t] = r[i ? 1 : 0]) : e == pi && (n[t] = o(r)));
            return n;
          };
  ...
  function K(r, n, t, xt, _t) {
    ...
    if (ht(r)) {
      ...
      var St,
        ...
        Dn = 'os-dragging',
        Me = 'os-theme-none',
        Mn = [Ae, xn, Tn, Hn, En, Ln, Re, Ne, We, De, Dn].join(xe),
        Fn = [],
        Pn = [xi.ti],
        jn = {},
        Fe = {},
          ...
          if (0 === arguments.length || n === di) {
            ...
            return (
              ...
              (a *= o ? -1 : 1),
              {
                ...
                handleLength: { x: vn.D, y: hn.D },
                handleLengthRatio: { x: vn.M, y: hn.M },
              ...
              St.x && St.y && !Vt.nativeScrollbarsOverlaid.initialize
                ...
                : (Rt &&
                  ...
                  (function s() {
                    ...
                    function c(n) {
                      return N && t ? { x: n.screenX, y: n.screenY } : Oi.page(n);
                    }
                    Yn(ir, U, function (n) {
                      a(n) &&
                        !Jr &&
                        (Vr && ((r = !0), Qe()),
                        (e = c(n)),
                        (i.w = ur[xi.oW] - (Nt ? 0 : Dt)),
                        (i.h = ur[xi.oH] - (Nt ? 0 : Mt)),
                        (o = vt()),
                        Xn(D, [K, $, V], [tt, u, f]),
                        ci(M, Dn),
    ...
    function Xn(n, t, r, e, i) {
      var o = Oi.isA(t) && Oi.isA(r),
        ...
        a = !o && t.split(xe),
        c = 0;
      if (o) for (; c < t[xi.l]; c++) Xn(n, t[c], r[c], e);
      else for (; c < a[xi.l]; c++) g ? n[0][u](a[c], r, { passive: i || !1 }) : n[f](a[c], r);
    }
    function Yn(n, t, r, e) {
    ...
    function qe(n) {
      ...
      if ((f && (qt = setTimeout(qe, Pe)), !(Et || f || (Ut && !u) || (Ht && !o && (t = Yt.is(':hidden'))) || 'inline' === Yt.css('display')))) {
        ...
        if (
          ...
          (Br = M),
          (dr = dr || { x: !1, y: !1 }),
          x && (si(Yt, Mr + xe + Me), ci(Yt, y !== di && null !== y && 0 < y.length ? y : Me)),
        ...
        var Y = (Qt = 'rtl' === U) ? le : ce,
          G = Qt ? ce : le,
          K = !1,
          J = !(!Wt || 'none' === Yt.css(be)) && 0 === Si.round(j.right - j.left) && (!!S || 0 < ur[xi.cW] - Dt);
        if (I && !J) {
          var Z = ur[xi.oW],
            nn = rr.css(de);
          rr.css(de, ge);
        ...
        var yn = !!Lt && $e(),
          xn = Lt && a(yn, jr),
          _n = Lt && yn ? { w: W ? yn.$ : yn.U, h: M ? yn.X : yn.V } : {};
        if (
          ((jr = yn),
          ...
          (ln = {}),
          (vn = {}),
          e || i || xn || V || q || z || en || rn || fn || un || H || N || k || O || h || p || w || m || D || F || Q)
        ) {
          var On = 'overflow',
            Sn = On + '-x',
            zn = On + '-y';
          ...
          var Ln = hn(),
            Rn = { w: Ln.w - jt - Ft - (Nt ? 0 : Dt), h: Ln.h - Bt - Pt - (Nt ? 0 : Mt) },
          ...
          if (((Nn.c = a(Nn, zr)), (zr = Nn), I)) {
            ...
            Dn(!0), Dn(!1), Lt && er.css(Wn), rr.css(vn);
          }
          rn && (ln[de] = ye), !rn || Nt || Vr || (ln[be] = 'none'), nr.css(ln), (ln = {});
          var Mn = { w: Tn[xi.sW], h: Tn[xi.sH] };
          (Mn.c = i = a(Mn, vr)), (vr = Mn), (ee = dn()), (e = a((Ln = hn()), lr)), (lr = Ln);
          var Fn = Lt && (0 === ee.w || 0 === ee.h),
            ...
            Yn = function (n) {
              ...
              (jn[e] = 'v-s' === R[e]),
                (Bn[e] = 'v-h' === R[e]),
                (Qn[e] = 's' === R[e]),
                (Un[e] = Si.max(0, Si.round(100 * (Mn[i] - ee[i])) / 100)),
          ...
          if ((Yn(!0), Yn(!1), (Un.c = a(Un, kr)), (kr = Un), (Vn.c = a(Vn, dr)), (dr = Vn), ($n.c = a($n, pr)), (pr = $n), St.x || St.y)) {
            var Gn,
              ...
              Jn = {},
              Zn = o;
            (Vn.x || Vn.y) && ((Jn.w = St.y && Vn.y ? Mn.w + zt.y : me), (Jn.h = St.x && Vn.x ? Mn.h + zt.x : me), (Zn = a(Jn, hr)), (hr = Jn)),
              (Vn.c || $n.c || Mn.c || V || en || fn || rn || un || H) &&
                ((ln[oe + G] = ln[fe + G] = me),
                (Gn = function (n) {
                  var t = ni(n),
                    r = ni(!n),
          ...
          if ((nr.css(ln), Lt && i)) {
            var ot = (function yt() {
              ...
              return { J: s, Z: l, nn: u, tn: c, rn: a, en: n, in: i };
            })();
            if (ot) {
              var ut = Pr === di || ot.nn !== Pr.nn,
                ft = ot.J,
                at = ot.Z,
                ct = ot.rn,
                st = ot.nn,
          ...
          li(Yt, ke, $n.x || $n.y),
            ...
            V && li(Yt, Se, Qt),
            Rt && ci(Yt, ze),
            O && (li(Yt, ze, Jr), li(ir, Re, !Jr), li(ir, Ne, Zr), li(ir, We, ne), li(ir, De, te)),
        ...
        Rt &&
          Ur &&
          (dr.c || Ur.c) &&
          (Ur.f || Ve(), St.y && dr.x && nr.css(ve + de, Ur.w + zt.y), St.x && dr.y && nr.css(ve + pe, Ur.h + zt.x), (Ur.c = !1)),
    ...
    function ut(e) {
      var n = 'parent',
        ...
        f = [rn, en, on, ze, Se, un, fn, an, Ce, ke, Ie, Te, Me, mn, Cn, Dr].join(xe),
        a = {};
        ...
        : Yn(nr, J, function v(n) {
            !0 !== Tr &&
              (function l(n) {
                ...
                return (
                  ('s' === Cr.y || 'v-s' === Cr.y) && ((c = s(u, n)) || Nt || (c = s(f, n))), a && !c && ((c = s(i, n)) || Nt || (c = s(o, n))), c
                );
    ...
    function at(i) {
      var n,
        ...
        o = function (n) {
          var t = pt(kn + xe + (n ? Nn : Wn), !0),
            r = pt(In, t),
            e = pt(An, t);
          return p || i || (t.append(r), r.append(e)), { un: t, an: r, cn: e };
        };
      function r(n) {
        var t = ni(n),
          r = t.un,
      ...
      i
        ? (r(!0), r())
        : ((n = o(!0)), (t = o()), (a = n.un), (s = n.an), (l = n.cn), (v = t.un), (b = t.an), (m = t.cn), p || (Jt.after(v), Jt.after(a)));
    }
    function ct(_) {
      var O,
        i,
        ...
        f = [16, 17];
      function a(n) {
        return N && t ? n['screen' + e] : Oi.page(n)[k];
      }
      function c(n) {
      ...
      function H(n) {
        var t = (n.originalEvent || n).touches !== di;
        return !(Ut || Et || dt() || !Rr || (t && !c('touchSupport'))) && (1 === Oi.mBtn(n) || t);
      }
      function h(n) {
        if (H(n)) {
          var t = C.F,
            r = C.D,
            e = C.N * (((a(n) - S) * z) / (t - r));
          (e = isFinite(e) ? e : 0), Qt && _ && !Ct.i && (e *= -1), Zt[I](Si.round(i + e)), P && Je(_, i + e), g || Oi.prvD(n);
        } else E(n);
      }
      function E(n) {
        if (
          ((n = n || n.originalEvent),
          Xn(D, [$, V, Y, G, K], [h, E, v, A, tt], !0),
          P && Je(_, !0),
          (P = !1),
          si(M, Dn),
          si(r.cn, o),
          ...
          (z = 1),
          l(),
          O !== (S = i = di) && (Ot.scrollStop(), clearTimeout(O), (O = di)),
          n)
        ) {
          var t = ur[xi.bCR]();
      ...
      Yn(r.cn, U, function d(n) {
                          ...
                          ? (Zt[I](a),
                            m
                              ? ((a = Zt[I]()),
                                ...
                                (a = c && Ct.n ? -a : a),
                                (l[k] = a),
                                Ot.scroll(l, ai(v, { duration: 130, complete: y })))
                              : y())
                          : ((h = g ? s : h),
                            (c ? (h ? n <= t + e : t <= n) : h ? t <= n : n <= t + e)
                              ? (clearTimeout(O), Ot.scrollStop(), (O = di), w(!0))
                              : ((O = setTimeout(x, f)), (l[k] = (h ? '-=' : '+=') + d), Ot.scroll(l, ai(v, { duration: u }))),
                            (g = !1));
                    }
                  };
                t && s(),
        ...
        Yn(r.un, U, function m(n) {
          Oi.stpP(n);
        }),
        W &&
          Yn(r.un, J, function (n) {
            n.target === r.un[0] && (Ke(_), Je(_));
          });
    }
    function Ye(n, t, r) {
      var e = n ? a : v;
    ...
    function Ge(n, t) {
      if ((clearTimeout(k), n)) si(a, Ln), si(v, Ln);
        ...
        var r,
          e = function () {
            F || Et || (!(r = l.hasClass('active') || m.hasClass('active')) && (Yr || Gr || Kr) && ci(a, Ln), !r && (Yr || Gr || Kr) && ci(v, Ln));
          };
    ...
    function Ke(n) {
      var t = {},
        r = ni(n),
        e = r.sn,
        i = Si.min(1, (lr[r.j] - (Or ? (n ? Dt : Mt) : 0)) / vr[r.j]);
      (t[r.Y] = Si.floor(100 * i * 1e6) / 1e6 + '%'), dt() || r.cn.css(t), (e.D = r.cn[0]['offset' + r.ln]), (e.M = i);
    }
    function Je(n, t) {
      var r,
        e,
        ...
        v = t === di || i ? l : t,
        h = f.D,
        d = u.an[0]['offset' + u.ln],
        p = d - h,
        b = {},
        m = (cr[we + u.ln] - cr['client' + u.ln]) * (Ct.n && o ? -1 : 1),
        g = function (n) {
    ...
    function st(n) {
      (ir = ir || pt(Rn, !0)), n ? (p && Ht ? si(ir.removeAttr(xi.s), Mn) : gt(ir)) : p || Yt.append(ir);
    }
    function ti(n, t, r) {
      if (!1 !== r)
        if (Ht) {
    ...
    function lt(n, t) {
      ...
      return new RegExp('(^' + rn + '([-_].+|)$)' + o(Dr, n) + o(Mr, t), 'g');
    }
    function vt() {
      var n = ar[xi.bCR]();
