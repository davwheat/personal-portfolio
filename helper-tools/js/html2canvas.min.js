  ...
  return (function (A) {
    ...
    function (A, e, t) {
      ...
      var r = (function () {
        ...
        G = function (A, e, t, r, n) {
          ...
          if (8 === P(B, e)) return S;
          if (11 === X.get(A[B]) && (D === y || D === p || D === K)) return T;
          if (7 === a || 7 === D) return T;
          if (9 === a) return T;
          ...
          if (D === U && -1 !== z.concat(U, u, h, y, p, K).indexOf(a)) return T;
          if ((-1 !== z.indexOf(D) && a === h) || (-1 !== z.indexOf(a) && D === h)) return T;
          if ((a === H && -1 !== [y, p, K].indexOf(D)) || (-1 !== [y, p, K].indexOf(a) && D === d)) return T;
          if ((-1 !== z.indexOf(a) && -1 !== x.indexOf(D)) || (-1 !== x.indexOf(a) && -1 !== z.indexOf(D))) return T;
          if (
            (-1 !== [H, d].indexOf(a) && (D === h || (-1 !== [F, Q].indexOf(D) && e[o + 1] === h))) ||
            (-1 !== [F, Q].indexOf(a) && D === h) ||
              ...
              r(A, [
                {
                  ...
                  value: function (A) {
                    ...
                    if (A >= 0) {
                      ...
                      if (A < this.highStart)
                        return (
                          (e = g - F + (A >> s)), (e = this.index[e]), (e += (A >> B) & h), (e = ((e = this.index[e]) << o) + (A & Q)), this.data[e]
                        );
    ...
    function (A, e, t) {
            ...
            (function (A, e, t) {
                      ...
                      ? A.forEach(function (A, t) {
                          ...
                          0 === t ? e.ctx.moveTo(n.x, n.y) : e.ctx.lineTo(n.x, n.y),
                            A.type === r.BEZIER_CURVE &&
                              e.ctx.bezierCurveTo(A.startControl.x, A.startControl.y, A.endControl.x, A.endControl.y, A.end.x, A.end.y);
                        })
              ...
              },
              {
                ...
                value: function (A, e) {
                  ...
                  return (
                    (t.width = e.width), (t.height = e.height), t.getContext('2d').drawImage(A, 0, 0, A.width, A.height, 0, 0, e.width, e.height), t
                  );
                },
              },
              {
                ...
                value: function () {
                  if (this.enabled && window.console && window.console.log) {
                    ...
                    Function.prototype.bind
                      ...
                      .apply(
                        window.console,
                        [Date.now() - this.start + 'ms', this.id ? 'html2canvas ('.concat(this.id, '):') : 'html2canvas:'].concat([].slice.call(e, 0))
                      );
                  }
                },
              },
      ...
      var L = (function () {
        ...
        J = function (A, e, t) {
          ...
          return {
            ...
            bottomLeftInner:
              i > 0 || c > 0
                ? _(A.left + e[3].borderWidth, A.top + g, Math.max(0, i - e[3].borderWidth), c - e[2].borderWidth, R.BOTTOM_LEFT)
        ...
        MA = function (A) {
          ...
          return null === e
            ...
            : {
                transform: e,
                transformOrigin: TA(
                  A.transformOrigin || A.webkitTransformOrigin || A.mozTransformOrigin || A.msTransformOrigin || A.oTransformOrigin
                ),
              };
        },
        TA = function (A) {
            ...
            })(A, [
              {
                ...
                value: function (A) {
                  ...
                  return kA(t).then(function (t) {
                    return (
                      A.backgroundColor &&
                        ((e.ctx.fillStyle = A.backgroundColor.toString()), e.ctx.fillRect(0, 0, A.width * A.scale, A.height * A.scale)),
        ...
        kA = function (A) {
          return new Promise(function (e, t) {
            ...
            (r.onload = function () {
              ...
              (r.onerror = t),
              (r.src = 'data:image/svg+xml;charset=utf-8,'.concat(encodeURIComponent(new XMLSerializer().serializeToString(A))));
          });
        },
        JA = function (A) {
        ...
        RA = {
          ...
          get SUPPORT_BASE64_DRAWING() {
            return function (A) {
              ...
              return (
                Object.defineProperty(RA, 'SUPPORT_BASE64_DRAWING', {
                  value: function () {
                    return e;
                  },
                }),
      ...
      var ee = function A(e, t, n) {
        ...
        se = [Be, Be, Be, Be],
        oe = { backgroundColor: ne, backgroundImage: [], backgroundClip: W.PADDING_BOX, backgroundOrigin: Y.PADDING_BOX },
        ae = new v('50%'),
        ie = [ae, ae],
        ce = [ie, ie, ie, ie],
        Qe = new v('3px'),
              ...
              case 1:
                (s.style.left = 'auto'),
                  (s.style.right = ''.concat(
                    A.ownerDocument.defaultView.innerWidth - e.bounds.left - e.style.margin[1].getAbsoluteValue(e.bounds.width) + 7,
                    'px'
                  )),
                  (s.style.textAlign = 'right');
                break;
              case 0:
                (s.style.left = ''.concat(e.bounds.left - e.style.margin[3].getAbsoluteValue(e.bounds.width), 'px')),
                  (s.style.right = 'auto'),
        ...
        Me = function (A, e, t) {
          ...
          switch (e) {
            ...
            case 6:
              return ye(A, 1, 3999, pe, 3, r).toLowerCase();
            case 7:
              return ye(A, 1, 3999, pe, 3, r);
            case 8:
            ...
            case 12:
            case 49:
              return ye(A, 1, 9999, Ke, 3, r);
            case 35:
              return ye(A, 1, 9999, Ke, 3, r).toLowerCase();
            case 13:
            ...
            case 20:
              return ye(A, 1, 19999, be, 3, r);
            case 21:
              return ve(A, 2790, 2799, !0, r);
            case 22:
              return ve(A, 2662, 2671, !0, r);
            case 22:
              return ye(A, 1, 10999, me, 3, r);
            case 23:
      ...
      var We = /^(to )?(left|top|right|bottom)( (left|top|right|bottom))?$/i,
        ...
        $e = { left: new v('0%'), top: new v('0%'), center: new v('50%'), right: new v('100%'), bottom: new v('100%') },
        At = function (A, e, t) {
        ...
        et = function (A, e, t) {
          var r = (function (A) {
            ...
            s = B ? (null !== r ? rt(t ? r - 0.5 * Math.PI : r, e) : n ? Bt(A[0], e) : st(A[0], e)) : rt(Math.PI, e),
            o = B ? 1 : 0,
        ...
        tt = function (A, e, t) {
          ...
          r &&
            ...
            r[10] ? (s.y = $e[r[10].toLowerCase()]) : void 0 !== r[11] && (s.y = I(A, r[11], r[12])));
          var o = {
        ...
        at = function (A, e, t, r, n) {
          ...
          switch (A) {
            case 'closest-side':
              0 === e
                ? (o = a = Math.min(Math.abs(B), Math.abs(B - n.width), Math.abs(s), Math.abs(s - n.height)))
            ...
            case 'farthest-side':
              0 === e
                ? (o = a = Math.max(Math.abs(B), Math.abs(B - n.width), Math.abs(s), Math.abs(s - n.height)))
      ...
      var wt = (function () {
                        ...
                        switch (A.repeat) {
                          case 2:
                            return [
                              ...
                              new M(Math.round(n.left + n.width), Math.round(t.height + r.top + e.y)),
                          ...
                          case 3:
                            return [
                              ...
                              new M(Math.round(r.left + e.x + t.width), Math.round(n.height + n.top)),
                          ...
                          case 1:
                            return [
                              ...
                              new M(Math.round(r.left + e.x + t.width), Math.round(r.top + e.y + t.height)),
        ...
        Ut = function (A) {
          for (var e = [], t = [], r = [], n = [], B = [], s = A.contexts.length, o = 0; o < s; o++) {
            var a = A.contexts[o];
            a.container.isPositioned() || a.container.style.opacity < 1 || a.container.isTransformed()
        ...
        Ft = function (A, e) {
          ...
          return new Promise(function (r, n) {
            ...
            if (
              ...
              (s.onerror = n),
              s.open('GET', ''.concat(t, '?url=').concat(encodeURIComponent(A), '&responseType=').concat(B)),
            ...
            dt(A, [
              {
                ...
                value: function (A) {
                  ...
                  if (yt(A)) return (this.cache[A] = vt(A, this.options.imageTimeout || 0)), A;
                  if (!Nt(A) || _A.SUPPORT_SVG_DRAWING) {
              ...
              },
              {
                ...
                value: function (A, e, t) {
                  ...
                  return (this.cache[A] = bt(e) && !Nt(e) ? _A.SUPPORT_BASE64_DRAWING(e).then(n) : n(!0)), A;
                },
              },
              {
                key: 'isSameOrigin',
          ...
          for (var l = 0; l < n; l++) {
            ...
            switch (w.type) {
              ...
              case 6:
                ...
                break;
              case 2:
                s && (B.push({ type: 0, value: s }), (s = '')), B.push({ type: 1, value: w.value || '' });
            }
          }
                      ...
                      sA(t.backgroundImage).map(function (A) {
                        return 'url' === A.method
                          ? e.resourceLoader
                              ...
                              .catch(function (A) {})
                          : Promise.resolve(''.concat(A.prefix).concat(A.method, '(').concat(A.args.join(','), ')'));
                      })
                    ).then(function (A) {
                        ...
                        .then(function (e) {
                          return new Promise(function (t, n) {
                            ...
                            (B.onload = function () {
                              ...
                              (B.src = e.toDataURL()),
                              r.parentNode && r.parentNode.replaceChild(b(A.ownerDocument.defaultView.getComputedStyle(A), B), r);
                          });
                        })),
                      r
                    );
                  ...
                  for (
                    ...
                    (a.nodeType === Node.ELEMENT_NODE &&
                      ('SCRIPT' === a.nodeName ||
                        ...
                        ('function' == typeof this.options.ignoreElements && this.options.ignoreElements(a)))) ||
          ...
          return s
            ...
            : (function (A, e, t, r, n, B) {
                ...
                var e = (function (A, e) {
                    ...
                    return (
                      (function A(e, t, r, n, B) {
                        for (var s, o = e.firstChild; o; o = s) {
                          ...
                          if (o instanceof a.Text || o instanceof Text || (a.parent && o instanceof a.parent.Text))
                            ...
                            if (-1 === xe.indexOf(o.nodeName)) {
                              ...
                              if (i.isVisible()) {
                                'INPUT' === o.tagName
                                  ...
                                  : 'SELECT' === o.tagName
                                  ? Fe(o, i)
                                  : i.style.listStyle && -1 !== i.style.listStyle.listStyleType && Ee(o, i, n);
                  ...
                  c = s.ownerDocument;
                return (
                  a === i.container.style.background.backgroundColor && (i.container.style.background.backgroundColor = F),
      ...
      var rr = function (A, e) {
        ...
        r.log('html2canvas '.concat('1.0.0-rc.0'));
