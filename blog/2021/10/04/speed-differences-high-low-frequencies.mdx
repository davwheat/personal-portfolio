...
QAM, [check out my previous article](/blog/2021/08/21/ofdm-subcarriers-rb-in-4g-lte-and-5g) about <!--
...
Remember from my OFDM article, linked above, that we can calculate the maximum theoretical throughput using the number of resource blocks and
