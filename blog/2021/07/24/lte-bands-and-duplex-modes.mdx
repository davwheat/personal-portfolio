---
title: How do LTE frequency bands and duplex modes affect throughput?
...
import { FactBox, MathBlock, BenefitsTable } from '@blog'
...
upwards of 26 GHz. These frequencies can be blocked using just sheets of paper, let alone brick walls or
...
<BenefitsTable columnHeadings={['LTE-TDD', 'LTE-FDD']}>
  {() => [
    [
      ...
      { text: 'Less expensive', description: ['No need to buy expensive duplexer', 'Less spectrum needs to be licensed'] },
    ],
    [
      {
