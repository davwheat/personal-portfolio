...
It supercedes Frequency Division Multiplexing (FDM), where signals do not overlap, and require a spacer (guard band) between them.

## Subcarriers

These individual signals that are multiplexed using FDM and OFDM, in 5G and LTE, are called subcarriers. These subcarriers are what are used to
...
spacing is flexible (one of: 15 kHz, 30 kHz, 60 kHz, 120 kHz, 240 kHz, 480 kHz) to allow for a vast range of use cases.
