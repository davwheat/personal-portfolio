...
Orion installations differ between vendor zones. Most Orion sites we've seen have been O2 <Tooltip text="single operator">unilaterals</Tooltip>
using Ericsson equipment. We've seen some Cornerstone shared MORAN (multiple operator radio access network) sites (where O2 and Vodafone are both
located on the monopole), though.
...
3278 32T32R massive MIMO antenna panels for 5G 3500 MHz n78, and Ericsson ERS 8808 8TRx panels for 2300 MHz B40 LTE.
