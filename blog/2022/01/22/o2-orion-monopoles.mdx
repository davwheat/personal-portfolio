...
O2 (<Tooltip text="MCC: 234, MNC: 10"><code>234/10</code></Tooltip>) is the largest mobile network operator in the United Kingdom in terms of
customers. Including its <Tooltip text="Mobile virtual network operators">MVNOs</Tooltip>, O2's customer base totals a whopping 36.2 million
customers in a country of just 67 million, meaning they have a market share of 54%.
...
The compact nature of Orion monopole sites mean that councils would probably be more likely to approve them compared to monopoles from other
operators which may clutter public areas with various street furniture. This is especially apparent if you compare Orion sites to similar Phase 7
sites from Mobile Broadband Networks Limited (MBNL), which provide all radio technologies for Three and EE.
...
Unlike the [previous Ericsson sites seen by Peter and Jake in Cardiff](https://www.youtube.com/watch?v=ou_CGjbQ8uc), this site doesn't appear to
be equipped for a massive MIMO deployment, instead preferring 8T8R for n78 5G.
...
- 5G
  ...
  - 2T4R 700 MHz NR (n28) at 10 MHz, paired
- 4G
